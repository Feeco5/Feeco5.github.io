...
<?php 
  ...
  { 
    $dblama = mysqli_query($connection, "SELECT * from detailreturpenj WHERE drpKODE = '$drKODE'");
    ...
    $kartonbaru = $karton + $lama['drpKARTON'];
    $harga = $rowb['harga'];
    ...
    $lastUPDATE ="$mydate[year]-$mydate[mon]-$mydate[mday]  $mydate[hours]:$mydate[minutes]:$mydate[seconds] ";
      ...
      drpKARTON = '$kartonbaru',
      drpTOTALHARGA = '$totalprice'
      WHERE drpKODE = '$drKODE'");
      
      if($result) {
        echo '<script> alert("Barang Berhasil ditambah!"); window.location="retur.php" </script>';
      }
      else {
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Detail Retur</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
