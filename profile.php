          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo $rowedit['partnerNAME'] ?></h3>

                <p class="text-muted text-center"><?php echo $rowedit['jenispartnerNAME'] ?></p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Last Shipped</b> <a class="float-right">1,322</a>
                  </li>
                  <li class="list-group-item">
                    <b>Last Order</b> <a class="float-right">543</a>
                  </li>
                  <li class="list-group-item">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <strong><i class="fas fa-book mr-1"></i>Email / Phone Number</strong>

                <p class="text-muted">
                  <?php echo $rowedit['partnerEMAIL']?> / <?php echo $rowedit['partnerPHONE']?> 
                </p>
                ...
                <p class="text-muted"><?php echo $rowedit['partnerADDRESS'] ?></p>
